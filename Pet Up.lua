...
function FindPet(Part)
	...
	if CheckPart.Name == "Handle" then
		if CheckPart.TextureID == "rbxassetid://6186812593" then
...
print "Negros,Parecen cucarachas cuando se amontonan"
function FEWeldlol(Part0,Part1)
	...
	AttachmentC.Orientation = Vector3.new(0,180,0)
	AttachmentA.Position = Vector3.new(-3,3,0)
...
for i = 1,#Descendants do
	if Descendants[i].Name == "Anareloux_Bloxikin" then
